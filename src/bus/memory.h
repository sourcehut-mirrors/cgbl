...
#define CGBL_MEMORY_RAM_HIGH_WIDTH CGBL_WIDTH(CGBL_MEMORY_RAM_HIGH_BEGIN, CGBL_MEMORY_RAM_HIGH_END)
#define CGBL_MEMORY_RAM_WORK_WIDTH CGBL_WIDTH(CGBL_MEMORY_RAM_WORK_0_BEGIN, CGBL_MEMORY_RAM_WORK_0_END)
