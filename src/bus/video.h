...
#define CGBL_VIDEO_RAM_WIDTH CGBL_WIDTH(CGBL_VIDEO_RAM_BEGIN, CGBL_VIDEO_RAM_END)
#define CGBL_VIDEO_RAM_OBJECT_WIDTH (CGBL_WIDTH(CGBL_VIDEO_RAM_OBJECT_BEGIN, CGBL_VIDEO_RAM_OBJECT_END) / sizeof(cgbl_object_t))
