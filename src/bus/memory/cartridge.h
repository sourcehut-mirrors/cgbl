...
#define CGBL_CARTRIDGE_RAM_WIDTH CGBL_WIDTH(CGBL_CARTRIDGE_RAM_BEGIN, CGBL_CARTRIDGE_RAM_END)
#define CGBL_CARTRIDGE_ROM_WIDTH CGBL_WIDTH(CGBL_CARTRIDGE_ROM_0_BEGIN, CGBL_CARTRIDGE_ROM_0_END)
