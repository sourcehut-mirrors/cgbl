...
static const float PULSE[][8] = { { -1.f, -1.f, -1.f, -1.f, -1.f, -1.f, -1.f, 1.f },
                                  { -1.f, -1.f, -1.f, -1.f, -1.f, -1.f, 1.f, 1.f },
                                  { -1.f, -1.f, -1.f, -1.f, 1.f, 1.f, 1.f, 1.f },
                                  { 1.f, 1.f, 1.f, 1.f, 1.f, 1.f, -1.f, -1.f } };

static const uint8_t SHIFT[] = { 4, 0, 1, 2 };
...
const float (*cgbl_audio_sample(void)) [CGBL_AUDIO_SAMPLES] { return &audio.sample; }
